...
namespace BookWebApi.AuthHelper.Policys
{
    /// <summary>
    /// 权限授权处理器
    /// </summary>
    public class PermissionHandler : AuthorizationHandler<PermissionRequirement>
    {
        ...
        public PermissionHandler(IAuthenticationSchemeProvider schemes, IHttpContextAccessor accessor, IRoleModulePermissionRepository roleModulePermissionRepository)
        {
            _accessor = accessor;
            Schemes = schemes;
        ...
        {   
            ...
            var userss = httpContext.User.Identities;
